...
using SAESP_manha.Data;
using SAESP_manha.Models;

namespace SAESP_manha.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        {
            var context = _context.Comentarios.Include(c => c.Equipamentos).Include(c => c.Perfis);
        ...
        public async Task<IActionResult> Create([Bind("Id,Comentario,IdPerfil,IdEquipamento,Data")] Comentarios comentarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comentario,IdPerfil,IdEquipamento,Data")] Comentarios comentarios)
        {
